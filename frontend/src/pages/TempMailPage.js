          ...
          {!session ? (
            ...
            <motion.div variants={itemVariants} className="text-center">
              <div className="bg-white rounded-xl shadow-soft p-8 max-w-md mx-auto">
                ...
                <h2 className="text-2xl font-display font-semibold text-dark-900 mb-4">
                ...
                <div className="bg-white rounded-xl shadow-soft p-6 sticky top-6">
                  ...
                  <div className="mb-6">
                    ...
                    <div className={`text-2xl font-display font-bold ${
                      timeRemaining < 300 ? 'text-red-500' : 'text-primary-600'
                    }`}>
                          ...
                          {messages.map((message) => (
                            <motion.div
                              ...
                              className={`p-4 hover:bg-gray-50 cursor-pointer transition-colors ${
                                !message.is_read ? 'bg-blue-50 border-l-4 border-l-primary-500' : ''
                              }`}
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center mb-1">
                                    <span className={`text-sm font-medium ${
                                      !message.is_read ? 'text-dark-900' : 'text-dark-700'
                                    }`}>
                                  ...
                                  <p className={`text-sm mb-1 ${
                                    !message.is_read ? 'font-medium text-dark-900' : 'text-dark-600'
                                  }`}>
