"""
Django settings for urlbriefr project.
...
SECRET_KEY = 'django-insecure-bwj4av56je&)u8-w4b+zwpd8b)k7t7r5wxady91ax)e06!(xs3'
...
WSGI_APPLICATION = 'urlbriefr.wsgi.application'
